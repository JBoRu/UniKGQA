...
input_file = sys.argv[1] # "/mnt/jiangjinhao/PLM4KBQA/data/Freebase/NSM_related/webqsp/webqsp_step0_test.json"
output_file = sys.argv[2] # "/mnt/jiangjinhao/PLM4KBQA/data/Freebase/NSM_related/webqsp/webqsp_seed_test.txt"
