...
def fetch_triple_1hop(kb_file, seed_file, output, cvt_nodes, cvt_hop=True):
    ...
    for line in f:
        ...
        if num_tot % 1000000 == 0:
            print("seed-hop1", num_tot, num_res, len(cvt_set))
    f.close()
    num_tot = 0
    num_res = 0
    if cvt_hop:
        ...
        for line in f:
            ...
            if spline[0] in cvt_set:
                ...
                num_res += 1
            if num_tot % 1000000 == 0:
                print("cvt-hop1", num_tot, num_res)
        f.close()
    f_out.close()
    return cvt_set
...
if __name__ == "__main__":
    ...
    seed_file = "./cwq/cwq_seed.txt"
    output_path = ".//cwq/subgraph/"
    kb_file = "./manual_fb_filter.txt"
    # seed_file = "./webqsp/webqsp_seed.txt"
    # output_path = "./webqsp/subgraph/"
    # kb_file = "./manual_fb_filter.txt"
