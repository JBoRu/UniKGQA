...
def load_cvt():
    # filename = "./data/freebase_webqsp/data/cvtnodes.bin"
    filename = ".data/Freebase/FastRDFStore_data/cvtnodes.bin"
    f = open(filename, "rb")
...
if __name__ == "__main__":
    ...
    for item in tp_dict:
        ...
        if num == 20:
            exit(-1)
    # m.0100vl0f True <class 'bool'>
    # m.0100vq_m True <class 'bool'>
    # m.0100vsph True <class 'bool'>