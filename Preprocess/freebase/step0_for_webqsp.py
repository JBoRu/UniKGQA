...
data_folder = "./data/Freebase/NSM_related/webqsp"
data_file = ["train.jsonl", "dev.jsonl", "test.jsonl"]
output_file = "./data/Freebase/NSM_related/webqsp/webqsp_step0.json"
# data_folder = "./data/cwq"
# data_file = ["train.jsonl", "dev.jsonl", "test.jsonl"]
# output_file = "./data/Freebase/NSM_related/cwq/cwq_step0.json"
