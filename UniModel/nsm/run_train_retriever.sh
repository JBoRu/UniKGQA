...
--experiment_name webqsp_nsm_roberta_rel_query_adamw_linear_diff_lr_adamw_bs_20_wo_drop_ed_100_curriculum_not_self_loop --eps 0.95 --num_epoch 100 \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_100_curriculum_both_max_steps --eps 0.95 --num_epoch 100 \
...
--data_name .super.subgraph.nsm.input.jsonl --checkpoint_dir ../outputs/retriever_training_0/ --batch_size 1 --gradient_accumulation_steps 20 \
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_100_curriculum_each_steps_loss --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
--data_cache ../data/webqsp/data/super_sg_for_retriever.cache --overwrite_cache
# 调整输入数据集 81.52
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_100_curriculum_each_steps_loss_v1 --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_100_curriculum_each_steps_loss_v2 --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_100_curriculum_each_steps_loss_v3 --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_linear_dp_0.1_ed_100_no_self_loop_curriculum_each_steps_loss_v3 --eps 0.95 --num_epoch 100 \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_not_use_ent_emb_bs_20_linear_dp_0.1_ed_100_curriculum_each_steps_loss_v1 --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
...
--test_batch_size 20 --num_step 4 --entity_dim 100 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_not_use_ent_emb_bs_40_wo_dp_curriculum_each_steps_loss_v1 --eps 0.95 --num_epoch 100 \
...
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_200_curriculum_each_steps_loss --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
--data_cache ../data/webqsp/data/super_sg_for_retriever.cache --overwrite_cache
# 打乱数据集 81.22
...
--test_batch_size 20 --num_step 4 --entity_dim 200 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_200_each_steps_loss --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
--data_cache ../data/webqsp/data/super_sg_for_retriever.cache --overwrite_cache
# 使用plm初始化 80.92
...
--test_batch_size 20 --num_step 4 --entity_dim 200 --word_dim 300 --kg_dim 384 --kge_dim 100 --eval_every 2 --encode_type \
--experiment_name webqsp_nsm_roberta_bs_20_wo_drop_ed_200_plm_init_each_steps_loss --eps 0.95 --num_epoch 100 \
--use_self_loop --plm_lr 1e-5 --lr 5e-4 --word_emb_file word_emb_300d.npy --loss_type kl --reason_kb \
