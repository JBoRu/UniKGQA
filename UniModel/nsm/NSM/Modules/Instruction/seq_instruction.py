...
try:
    ...
    try:
        from nsm.NSM.Modules.Instruction.base_instruction import BaseInstruction
    except:
        from UniModel.nsm.NSM.Modules.Instruction.base_instruction import BaseInstruction
