...
try:
    ...
    try:
        from nsm.NSM.util.config import get_config
        from nsm.NSM.data.dataset_single import SingleDataLoader
    except:
        from UniModel.nsm.NSM.util.config import get_config
        from UniModel.nsm.NSM.data.dataset_single import SingleDataLoader
