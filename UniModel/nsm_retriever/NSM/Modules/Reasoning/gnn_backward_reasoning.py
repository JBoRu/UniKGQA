...
try:
    ...
    try:
        from nsm_retriever.NSM.Modules.Reasoning.base_reasoning import BaseReasoning
    except:
        from UniModel.nsm_retriever.NSM.Modules.Reasoning.base_reasoning import BaseReasoning
