...
try:
    ...
    try:
        from nsm_retriever.NSM.Model.base_model import BaseModel
        from nsm_retriever.NSM.Modules.Instruction.seq_instruction import LSTMInstruction
        from nsm_retriever.NSM.Modules.Reasoning.gnn_reasoning import GNNReasoning
        from nsm_retriever.NSM.Modules.Reasoning.gnn_backward_reasoning import GNNBackwardReasoning
    except:
        from UniModel.nsm_retriever.NSM.Model.base_model import BaseModel
        from UniModel.nsm_retriever.NSM.Modules.Instruction.seq_instruction import LSTMInstruction
        from UniModel.nsm_retriever.NSM.Modules.Reasoning.gnn_reasoning import GNNReasoning
        from UniModel.nsm_retriever.NSM.Modules.Reasoning.gnn_backward_reasoning import GNNBackwardReasoning
