...
try:
    ...
    from NSM.data.dataset_single import SingleDataLoader
except:
    try:
        from nsm_retriever.NSM.util.config import get_config
        from nsm_retriever.NSM.data.dataset_single import SingleDataLoader
    except:
        from UniModel.nsm_retriever.NSM.util.config import get_config
        from UniModel.nsm_retriever.NSM.data.dataset_single import SingleDataLoader
