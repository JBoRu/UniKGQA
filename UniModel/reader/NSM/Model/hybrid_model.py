...
try:
    ...
    from UniModel.reader.NSM.Modules.Instruction.seq_instruction import LSTMInstruction
    from UniModel.reader.NSM.Modules.Reasoning.gnn_reasoning import GNNReasoning
    from UniModel.reader.NSM.Modules.Reasoning.gnn_backward_reasoning import GNNBackwardReasoning
